...
import com.hc24.frame.spring.web.controller.config.BeanMethodArgumentResolver;
 ...
 */
public class MyRequestMappingHandlerAdapter extends AbstractHandlerMethodAdapter implements BeanFactoryAware,
		InitializingBean {
	...
	private List<HandlerMethodArgumentResolver> getDefaultArgumentResolvers() {
		...
		resolvers.add(new BeanMethodArgumentResolver());/* 新增自定义的，放到Map前面先被拿到 */
